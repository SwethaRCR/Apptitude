...
public class LoginPageValidation {
	public static void main(String[] args) {
	   ...
	   // WebElement usernameError = driver.findElement(By.xpath("//input[@name='username']//following-sibling::div[@class='error-message']"));
        //WebElement passwordError = driver.findElement(By.xpath("//input[@name='password']//following-sibling::div[@class='error-message']"));

         //assert usernameError.getText().equals("Username is required.") : "Username error message is incorrect.";
         //assert passwordError.getText().equals("Password is required.") : "Password error message is incorrect.";

		 WebElement Email = driver.findElement(By.xpath("//input[@type='email']"));
		 Email.sendKeys("swetha123@gmail.com");
		WebElement Password = driver.findElement(By.xpath("//input[@type='password']"));
		Password.sendKeys("Swetha@123");
	...
	private static void validateIncorrectCredentials(WebDriver driver, WebDriverWait wait) {
        ...
        usernameField.clear();
        passwordField.clear();
        usernameField.sendKeys("swetha321@gmail.com");
        ...
        assert errorMessage.getText().equals("Invalid username or password.") : "Error message for incorrect username is incorrect.";
	}
	 private static void validateBlankUsername(WebDriver driver, WebDriverWait wait) {
	        ...
	        usernameField.clear();
	        passwordField.sendKeys("Swetha@321"); 
	        loginButton.click();

	        
	        WebElement usernameError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='username']//following-sibling::div[@class='error-message']")));
	        assert usernameError.getText().equals("Username is required.") : "Username error message for blank field is incorrect.";
	    ...
	    private static void validateBlankPassword(WebDriver driver, WebDriverWait wait) {
	        ...
	        WebElement passwordError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//input[@name='password']//following-sibling::div[@class='error-message']")));
	        assert passwordError.getText().equals("Password is required.") : "Password error message for blank field is incorrect.";
	    ...
	    private static void validateSpecialCharactersInUsername(WebDriver driver, WebDriverWait wait) {
	        ...
	        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("errorMessage")));
	        assert errorMessage.getText().equals("Invalid username or password.") : "Error message for special characters in username is incorrect.";
	    ...
	    private static void validateSpecialCharactersInPassword(WebDriver driver, WebDriverWait wait) {
	        ...
	        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("errorMessage")));
	        assert errorMessage.getText().equals("Invalid username or password.") : "Error message for special characters in password is incorrect.";
	    ...
	    private static void validateSpecialCharactersInBothFields(WebDriver driver, WebDriverWait wait) {
	        ...
	        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("errorMessage")));
	        assert errorMessage.getText().equals("Invalid username or password.") : "Error message for special characters in both fields is incorrect.";
	    ...
	    private static void validateValidCredentials(WebDriver driver, WebDriverWait wait) {
	        ...
	        usernameField.clear();
	        passwordField.clear();
	        usernameField.sendKeys("swetha123@gmail.com"); // Example valid username
	        passwordField.sendKeys("Swetha@123"); // Example valid password
	        loginButton.click();
	        ...
	        assert driver.getCurrentUrl().equals("https://www.nokodrplatform.com/dashboard") : "Redirection to dashboard failed.";
	    ...
	    private static void submitAndVerifyInvalidCredentials(WebDriver driver, WebDriverWait wait) {
	        ...
	        usernameField.clear();
	        passwordField.clear();
	        usernameField.sendKeys("swethaa321@gmail.com");
	        passwordField.sendKeys("Swetha@321");
	        loginButton.click();

	        // Wait for the error message and verify it
	        WebElement errorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("errorMessage")));
	        assert errorMessage.getText().equals("Invalid username or password.") : "Error message for invalid username or password is incorrect.";
