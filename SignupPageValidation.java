...
public class SignupPageValidation {
    ...
    public static void main(String[] args) {
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
            ...
            driver.findElement(By.xpath("//div[@class='slds-float_right']/a")).click();
    ...
    public static void validateValidInputs(WebDriver driver, WebDriverWait wait) {
        ...
        driver.findElement(By.id("email")).sendKeys("swetha123@gmail.com");
        driver.findElement(By.id("password")).sendKeys("Swetha@123");
        driver.findElement(By.id("confirmPassword")).sendKeys("Swetha@123");
    ...
    public static void validateInvalidInput(WebDriver driver, WebDriverWait wait) {
        ...
        driver.findElement(By.id("email")).sendKeys("swetha321@gmail.com");
        driver.findElement(By.id("submitButton")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emailError")));

        
        driver.findElement(By.id("password")).clear();
        driver.findElement(By.id("password")).sendKeys("Swetha@321");
        driver.findElement(By.id("confirmPassword")).clear();
        driver.findElement(By.id("confirmPassword")).sendKeys("Swetha@321");
        driver.findElement(By.id("submitButton")).click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("confirmPasswordError")));
    ...
    private static void validateAllInputFields(WebDriver driver, WebDriverWait wait) {
        ...
        submitButton.click(); 
        WebElement confirmPasswordError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("confirmPasswordError")));
        assert confirmPasswordError.getText().equals("Confirm password is required.") : "Confirm password error message is incorrect.";

        //  Validate Email Format
        emailField.clear();
        emailField.sendKeys("invalidEmailFormat");
        submitButton.click(); 
        WebElement emailFormatError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emailFormatError")));
        assert emailFormatError.getText().equals("Invalid email format.") : "Email format error message is incorrect.";

        //  Validate Password Format (e.g., minimum length, uppercase letter, number, special character)
        passwordField.clear();
        passwordField.sendKeys("Swetha@123"); 
        submitButton.click(); 
        WebElement passwordFormatError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordFormatError")));
        assert passwordFormatError.getText().equals("Password must be at least 8 characters long, contain at least one uppercase letter, one number, and one special character.") : "Password format error message is incorrect.";

        //  Ensure Confirm Password Matches Password
        passwordField.clear();
        confirmPasswordField.clear();
        passwordField.sendKeys("Swetha@123");
        confirmPasswordField.sendKeys("Swetha@23"); 
        submitButton.click(); 
        WebElement passwordMismatchError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordMismatchError")));
        assert passwordMismatchError.getText().equals("Passwords do not match.") : "Password mismatch error message is incorrect.";
        ...
        passwordField.clear();
        confirmPasswordField.clear();
        nameField.sendKeys("Swetha");
        emailField.sendKeys("swetha123@gmail.com");
        passwordField.sendKeys("Swetha@123");
        confirmPasswordField.sendKeys("Swetha@123");
        submitButton.click();

        // Wait for successful submission and verify (e.g., redirection or success message)
        wait.until(ExpectedConditions.urlToBe("https://example.com/success"));
        assert driver.getCurrentUrl().equals("https://example.com/success") : "Form submission failed or redirection incorrect.";
    ...
    private static void validateInvalidInputs(WebDriver driver, WebDriverWait wait) {
        ...
        confirmPasswordField.clear();
        passwordField.sendKeys("Swetha@123");
        confirmPasswordField.sendKeys("Swetha@321");  
        submitButton.click();
        WebElement passwordMismatchError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("passwordMismatchError")));
        assert passwordMismatchError.getText().equals("Passwords do not match.") : "Password mismatch error message is incorrect.";
        ...
        nameField.clear();
        nameField.sendKeys("Swetha$123");  
        submitButton.click();
        WebElement nameSpecialCharError = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("nameSpecialCharError")));
        assert nameSpecialCharError.getText().equals("Name contains invalid characters.") : "Name special character error message is incorrect.";
    ...
    private static void submitAndVerify(WebDriver driver, WebDriverWait wait) {
        ...
        WebElement otpSuccessMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("otpSuccessMessage")));
