...
public class ForgotPasswordAutomation {
    ...
    public static void main(String[] args) {
        ...
        submitButton.click();
            ...
            assert successMessage.getText().equals("A password reset link has been sent to your email.") : "Success message is incorrect.";
            ...
            emailField.clear();
            emailField.sendKeys("swetha23@gmail.com");
            submitButton.click(); 
            ...
            emailField.clear();
            emailField.sendKeys("swetha321@gmail.com"); 
            submitButton.click(); 

           
            WebElement errorMessage1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("errorMessage")));
            assert errorMessage1.getText().equals("Email not found.") : "Error message for non-registered email is incorrect.";
            ...
            WebElement formatErrorMessage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emailFormatError")));
            assert formatErrorMessage.getText().equals("Invalid email format.") : "Error message for invalid email format is incorrect.";
            ...
            assert blankErrorMessage.getText().equals("Email is required.") : "Error message for blank email field is incorrect.";
            ...
            WebElement emailFormatError1 = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("emailFormatError")));
            assert emailFormatError1.getText().equals("Invalid email format.") : "Error message for invalid email format is incorrect.";
            ...
            assert blankErrorMessage1.getText().equals("Email is required.") : "Error message for blank email field is incorrect.";
